...
<head>
    ...
    <link href={{ asset('adminFolder/assets/libs/chartist/dist/chartist.min.css') }} rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src={{ asset('adminFolder/assets/images/logo-icon.png') }} alt="homepage"
                                    class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src={{ asset('adminFolder/assets/images/logo-light-icon.png') }} alt="homepage"
                                    class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src={{ asset('adminFolder/assets/images/logo-text.png') }} alt="homepage"
                                    class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src={{ asset('adminFolder/assets/images/logo-light-text.png') }} class="light-logo"
                                    alt="homepage" />
                            </span>
                        </a>
                    </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                                href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src={{ asset('adminFolder/assets/images/users/1.jpg') }} alt="user"
    ...
    <!--chartis chart-->
    <script src={{ asset('adminFolder/assets/libs/chartist/dist/chartist.min.js') }}></script>
    <script src={{ asset('adminFolder/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}>
    </script>
    <script src={{ asset('adminFolder/dist/js/pages/dashboards/dashboard1.js') }}></script>
